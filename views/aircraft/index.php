...
<?php if (empty($aircraft)): ?>
    <div class="card"><div class="empty-state" style="padding:40px 0;"><div class="icon"><?= sidebarIcon('paper-airplane', 32) ?></div><h3>No aircraft registered</h3><p>Click "Register Aircraft" to add the first aircraft.</p></div></div>
<?php else: ?>
