...
try {
    ...
    $modules = [
        ...
        ['duty_reporting',      'Duty Reporting',          'Crew report-for-duty and clock-out with geo-fence and exceptions', '🟢', 1, 55],
    ...
    $specialCaps = [
        ...
        'duty_reporting'  => ['view','check_in','clock_out','view_history','view_all','approve_exception','correct_record','manage_settings','export','view_audit'],
